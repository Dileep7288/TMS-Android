...
public class AdminDashBoard extends AppCompatActivity {
    ...
    private Button viewTasks, viewUsers,logoutBtn;
    ...
    protected void onCreate(Bundle si) {
        ...
        viewTasks.setOnClickListener(v -> {
            Intent i = new Intent(AdminDashBoard.this, TaskList.class);
            startActivity(i);
        });

        viewUsers.setOnClickListener(v -> {
            Intent i = new Intent(AdminDashBoard.this, UsersList.class);
            startActivity(i);
        });
